...
for (s in c("01_data", "02_scores", "03_cluster", "04_mechanism",
            ...
            "17_scrna_kp_heatmap", "18_reviewer_round9", "19_final_robustness", "20_immune_correction", "21_spatial_kp", "22_fig7_combined", "23_fig56_merge", "24_cibersortx_check", "25_random_geneset_control")) {
  message("\n================ ", s, " ================")
